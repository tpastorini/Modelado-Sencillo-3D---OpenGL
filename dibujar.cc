...
void Dibujar_ajedrez(vector<_vertex3f> vertices, vector<_vertex3i> triangulos){
	glBegin( GL_TRIANGLES );
		...
		for(unsigned int i=0; i<triangulos.size(); i++){
			if(i%2 == 0)			// Si el vertice es par, le pongo un color
				glColor3f(0.5,1,0);
			else					// Si es impar, otro color
				glColor3f(1,0,0.25);

			// Paso a dibujar los vértices
...
/*
*	Método que dibuja el objeto en modo alambre o líneas.
*/
...
/*
*	Método que dibuja la pirámide con una cara de cada color.
*/
...
/*
*	Método que dibuja el cubo con una cara de cada color.
*/
...
/*
*	Método que dibuja una variante del modo ajedrez, donde cada triángulo tiene un color diferente.
*/
...
/*
*	Método que dibuja un suavizado del objeto3D.
*/
...
/*
*	Método que dibuja los círculos en los vértices del objeto3D.
*/
...
/*
*	Método que establece el modo de visualización en función de cada tecla pulsada.
*/
